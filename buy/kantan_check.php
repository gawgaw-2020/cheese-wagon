...
try {
  ...
  $sql = 'SELECT user_name, user_email, user_postal1, user_postal2, user_address, user_tel FROM users WHERE user_id = ?';
  ...
  $user_postal1 = $rec['user_postal1'];
  $user_postal2 = $rec['user_postal2'];
...
$session = $stripe->checkout->sessions->create([
    ...
    'mode' => 'payment',
    // ご自身のサイトURLを入力
    // 'success_url' => 'http://cheese-wagon.crap.jp/buy/result.php?session_id={CHECKOUT_SESSION_ID}',
    // 'cancel_url' => 'http://cheese-wagon.crap.jp/buy/result.php?session_id={CHECKOUT_SESSION_ID}',
